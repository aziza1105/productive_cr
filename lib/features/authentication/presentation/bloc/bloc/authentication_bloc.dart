...
import 'package:productive_cr/features/authentication/data/data_source/remote.dart';
import 'package:productive_cr/features/authentication/data/repository/authentication.dart';
import 'package:productive_cr/features/authentication/domain/entity/authenticated_user.dart';
import 'package:productive_cr/features/authentication/domain/usecase/authenticate.dart';
import 'package:productive_cr/features/authentication/domain/usecase/logout.dart';
...
class AuthenticationBloc
  ...
  AuthenticationBloc()
    ...
    on<AuthenticationSignUpRequestedEvent>((event, emit) async {
      final usecase = AuthenticateUseCase(
        AuthenticationRepositoryImpl(
          dataSource: AuthenticationRemoteDataSource(),
        ),
